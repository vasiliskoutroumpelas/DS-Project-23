/*ΜΕΘΟΔΟΣ ΚΑΤΑΣΚΕΥΗΣ BALANCED BST:


1) ΔΗΜΙΟΥΡΓΙΑ ΕΝΟΣ (SKEWD/UNBALANCED) BST ΜΕ ΔΙΑΔΟΧΙΚΑ INSERT().
2) ΕΦΑΡΜΟΓΗ ΑΛΓΟΡΙΘΜΟΥ ΕΝΔΟΔΙΑΠΕΡΑΣΗΣ (INORDER) ΣΤΟ ΠΑΡΑΠΑΝΩ ΔΕΝΤΡΟ ΚΑΙ ΑΠΟΘΗΚΕΥΣΗ ΤΩΝ (πλεον sorted) ΤΙΜΩΝ ΣΕ ΕΝΑ ΔΙΑΝΥΣΜΑ VECTOR[].
3) ΑΥΤΟ ΤΟ SORTED VECTOR ΕΙΣΑΓΕΤΑΙ ΩΣ ΠΑΡΑΜΕΤΡΟΣ ΣΕ ΜΙΑ ΣΥΝΑΡΤΗΣΗ Η ΟΠΟΙΑ ΤΟ ΧΡΗΣΙΜΟΠΟΙΕΙ ΓΙΑ ΝΑ ΚΑΤΑΣΚΕΥΑΣΕΙ ΕΝΑ BALANCED BST TREE.


 ΛΕΠΤΟΜΕΡΕΙΑ ΥΛΟΠΟΙΗΣΗΣ ΜΟΥ:  ΜΕ ΤΗΝ ΠΑΡΑΠΑΝΩ ΜΕΘΟΔΟ ΚΑΤΑΦΕΡΝΩ ΝΑ ΚΑΤΑΣΚΕΥΑΣΩ ΕΝΑ BALANCED BST ΤΟ ΟΠΟΙΟ ΕΙΝΑΙ RIGHT !!! BALANCED
 (ΑΥΤΟ ΣΗΜΑΙΝΕΙ ΟΤΙ ΤΑ ΦΥΛΛΑ ΔΙΑΤΑΣΣΟΝΤΑΙ ΜΕ ΠΡΟΤΕΡΑΙΟΤΗΤΑ ΠΡΟΣ ΤΗ ΔΕΞΙΑ ΜΕΡΙΑ).
